module.exports = {
	...
	CK_BOSS :[
		{id: 101, msg: '普攻1-右脚火焰'},// "오른발화염공격_Atk01_d_노멀"
		{id: 102, msg: '普攻2-左脚寒冰'},// "왼발냉기공격_Atk02_d_노멀"
		{id: 103, msg: '后方-尾巴攻击'},// "꼬리공격_BackAtk_노멀"
		{id: 104, msg: '重击1-范围寒冰魔法'},// "주변광역냉기마법_HeavyAtk01_노멀"
		{id: 105, msg: '重击2-范围寒冰魔法'},// "주변광역화염마법_HeavyAtk02_노멀"
		{id: 106, msg: '移动-前方突进'},// "전방돌진공격_MoveAtk_노멀"
		{id: 107, msg: '普攻-周围的反应'},// "주변리액션공격_ReactionAtk_노멀"
		{id: 108, msg: '普通1-旋转攻击(左)'},// "회전공격(좌부터)_RoundAtk01_노멀"
		{id: 109, msg: '普通2-旋转攻击(右)'},// "회전공격(우부터)_RoundAtk02_노멀"
		{id: 110, msg: '右脚火炎DOT攻击-发射动作'},// "오른발화염DOT공격_Atk01_발사동작_노멀"
		{id: 111, msg: '右脚火炎DOT攻击-发射'},// "오른발화염DOT공격_Atk01_발사체_노멀"
		{id: 112, msg: '左脚冷气DOT攻击-发射动作'},// "왼발냉기DOT공격_Atk02_발사동작_노멀"
		{id: 113, msg: '左脚冷气DOT攻击-发射'},// "왼발냉기DOT공격_Atk02_발사체_노멀"
		{id: 114, msg: '前方火焰DOT魔法-发射动作'},// "전방화염DOT마법_HeavyAtk02_발사동작_노멀"
		{id: 115, msg: '前方火焰DOT魔法-发射'},// "전방화염DOT마법_HeavyAtk02_발사체_노멀"
		{id: 116, msg: '（火焰布雷斯用）活力四射'},// "(화염브레스용)액티브무브_Run_노멀"
		{id: 117, msg: '火焰布鲁斯'},// "화염브레스_breath_노멀"
		{id: 118, msg: '高空降落'},// "고공낙하_jumpAtk_노멀"
		{id: 119, msg: '微弱的咆哮'},// "약한포효_modealarm_노멀"
		{id: 120, msg: '猛烈的咆哮'},// "강한포효_Roar_노멀"
		{id: 121, msg: '复活诅咒'},// "부활저주_SpwanNpc_노멀"
		{id: 122, msg: '召唤部下'},// "부하소환_reactionAtk_노멀"
		{id: 123, msg: '等待-磁增益法术'},// "자기버프_Wait_노멀"
		{id: 124, msg: '弱高空落下'},// "약한 고공낙하_노멀"
		...
		{id: 130, msg: '禁止恢复结束'},// "회복금지_종료_SpawnNpc_노멀"
		{id: 131, msg: '广域1实例'},// "광역1인스턴_aggrochange_노말"
		...
		{id: 135, msg: '[暴走]凯克·萨克强悍的咆哮'},// "[폭주]켈사이크_강한포효_Roar_노멀"
		{id: 136, msg: '[暴走]凯克·赛克环形动作'},// "[폭주]켈사이크_루프동작_노멀"
		{id: 137, msg: '[暴走]柯尔莎挤出力量'},"[폭주]켈사이크_힘을짜냄_변신"
		{id: 138, msg: '[相位]相位变更'},// "[페이즈]페이즈변경_Wait_노멀"
		{id: 139, msg: '[温度]60温度变更'},// "[온도]60_온도변경_Wait_노멀"
		{id: 140, msg: '[温度]40温度变更'},// "[온도]40_온도변경_Wait_노멀"
		{id: 141, msg: '未知 旋转攻击(左/逆属性死亡)'},// "불근얼원_회전공격(좌/역속성사망)_RoundAtk01_노멀"
		{id: 142, msg: '不圆 旋转攻击(左/逆属性死亡)'},// "불원얼근_회전공격(좌/역속성사망)_RoundAtk01_노멀"
		{id: 143, msg: '半圆 旋转攻击(右/逆属性死亡)'},// "얼근불원_회전공격(우/역속성사망)_RoundAtk02_노멀"
		{id: 144, msg: '未知 旋转攻击(右/逆属性死亡)'},// "얼원불근_회전공격(우/역속성사망)_RoundAtk02_노멀"
		{id: 145, msg: '眩晕攻击'},// "스턴공격_ReactionAtk_노멀"
		{id: 150, msg: '活跃的'},// "액티브무브_Run_노멀"
		{id: 151, msg: '张力1 右脚火炎攻击'},// "텐션1_오른발화염공격_Atk01_d_노멀"
		{id: 152, msg: '张力1 左脚冷气攻击'},// "텐션1_왼발냉기공격_Atk02_d_노멀"
		{id: 153, msg: '张力1 尾巴攻击'},// "텐션1_꼬리공격_BackAtk_노멀"
		{id: 154, msg: '张力1 范围寒冰魔法'},// "텐션1_주변광역냉기마법_HeavyAtk01_노멀"
		{id: 155, msg: '张力1 范围火焰魔法'},// "텐션1_주변광역화염마법_HeavyAtk02_노멀"
		{id: 156, msg: '张力1 前方突进攻击'},// "텐션1_전방돌진공격_MoveAtk_노멀"
		{id: 157, msg: '张力1 前方突进攻击'},// "텐션1_주변리액션공격_ReactionAtk_노멀"
		{id: 158, msg: '张力1 周围的反应攻击1'},// "텐션1_회전공격(좌부터)_RoundAtk01_노멀"
		{id: 159, msg: '张力1 周围的反应攻击2'},// "텐션1_회전공격(우부터)_RoundAtk02_노멀"
		{id: 160, msg: '张力1 高空降落'},// "텐션1_고공낙하_jumpAtk_노멀"
		{id: 161, msg: '张力1 微弱的咆哮'},// "텐션1_약한포효_modealarm_노멀"
		{id: 162, msg: '张力1 猛烈的咆哮'},// "텐션1_강한포효_Roar_노멀"
		{id: 163, msg: '张力1 弱高空落下'},// "텐션1_약한 고공낙하_노멀"
		{id: 164, msg: '[温度]100度 全灭'},// "[온도]100도 전멸기"
		{id: 165, msg: '[温度]100度 全灭'},// "[온도]0도 전멸기"
		{id: 201, msg: '呼哧呼哧动作'},// "헉헉동작_Groggy_노멀"
		{id: 204, msg: '换人'},// "어그로체인지_aggrochange_노멀"
		{id: 205, msg: '前方跳跃回避'},// "전방점프회피_Jumpevasion_노멀"
		{id: 206, msg: '后方跳跃闪避'},// "후방점프회피_Jumpevasion_노멀"
		{id: 209, msg: '模式提醒'},// "모드알람_ModeAlarm_더미"
		{id: 210, msg: '赞助动作'},// "스폰동작_Spawn_노멀"
		{id: 211, msg: '旋转结束用'},// "회전종료용_ModeAlarm_노멀"
		{id: 212, msg: '旋转开始计时 火-根'},// "회전 시작 알람_화,근_ModeAlarm_노멀"
		{id: 213, msg: '旋转开始计时 冰-根'},// "회전 시작 알람_얼,근_ModeAlarm_노멀"
		{id: 214, msg: '旋转开始计时 火-圆'},// "회전 시작 알람_화,원_ModeAlarm_노멀"
		{id: 215, msg: '旋转开始计时 冰-圆'},// "회전 시작 알람_얼,원_ModeAlarm_노멀"
