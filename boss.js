module.exports = {
	...
	// 狂气竞技场()
	KQ_BOSS : [
		{id: 108, msg: '一刀'},        // 101-121-122-連續攻擊 -> 108一刀兩斷(坦)
		{id: 355, msg: '下巴粉碎'},    // 102-121-103-連續攻擊 -> 355右手蓄力 -> 114下巴粉碎
		{id: 135, msg: '一刀'},        //         104-連續攻擊 -> 135左手蓄力 -> 130一刀兩斷
		{id: 111, msg: '一刀'},        //         104-連續攻擊 -> 111憤怒一擊 -> 130一刀兩斷
		{id: 112, msg: '后跳 | 一刀'}, //     121-102-連續攻擊 -> 112後退踢擊 -> 130一刀兩斷
		
		{id: 116, msg: '完美格挡'},    // 116斬擊
		{id: 140, msg: '完美格挡'},    // 145重擊斬 -> 139迴旋砍擊x2 -> 140斬擊
		{id: 144, msg: '一刀'},        // 136重擊斬 -> 144迴旋砍擊x1 -> 130一刀兩斷
		
		{id: 109, msg: '前跳 | 一刀'}, // 109向下劈擊 -> 402等待
		{id: 134, msg: '要害(转身)'},  // 134要害攻擊 -> 147一刀兩斷
		{id: 117, msg: '瞬闪(点名)'},  // 117瞬閃点名 -> 130一刀兩斷
		{id: 356, msg: '瞬闪(点名)'},  // 356瞬閃点名 -> 147一刀兩斷
		
		{id: 357, msg: '爆炸(远离)'},  // 357吸收力量 -> 110起身攻擊 -> 氣斬
		{id: 350, msg: '甜甜圈'},      // 350吸收力量 -> 302甜甜圈
		
		{id: 351, msg: '破盾!!'},      // 护盾开始 环形爆发
		
		{id: 401, msg: '30%'},         // 开始
		{id: 141, msg: '一刀 | 下巴 | 一刀'}, // 141破壞氣魄 -> 迴旋砍擊x2 146一刀兩斷 -> 114下巴粉碎 -> 130一刀兩斷
		{id: 142, msg: '下巴 | 一刀'},        // 142破壞氣魄 -> 迴旋砍擊x2             -> 114下巴粉碎 -> 130一刀兩斷
		{id: 151, msg: '三斩 | 一刀'}  // 151三斬 149三斬 148三斬 130一刀兩斷
		// 105 連續攻擊
		// 106 迴旋砍擊x2
		// 107 刀背打擊 / 神經劈擊
		// 113 ???
