module.exports = {
	...
	SI_BOSS_2 : [
		// 101 "휴먼 남 사제_징벌의 빛"
		// 102 "휴먼 남 사제_징벌의 장막"
		{id: 103, msg: '吸蓝(闪避)'} // "휴먼 남 사제_치유의 바람"
		// 104 "휴먼 남 사제_회복장판발사체"
		// 105 "휴먼 남 사제_파멸"
		// 106 "휴먼 남 사제_파멸 발사체"
		// 107 "휴먼 남 사제_파멸 발사체2"
	...
	SI_BOSS_3 : [
		...
		{id: 122, msg: '转圈 | 前砸'}, // "해적단장_차지2_SelfBuffOn_공용" (紫)_滚开  +No.1 buff
	...
	//  {id: 125, msg: '转圈'},        // "해적단장_원폭_WhirlwindStart_노말"  第一击 / 第二击
        ...
        {id: 138,msg: "138 ?"}, // "안-밖(발사체)"
        {id: 202,msg: "202 ? (防御3秒)"} // "defence 3초"
	],
	SI_TipMsg : ["闪电", "毒气"]
}
