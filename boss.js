module.exports = {
	...
	VS_TipMsg : ["Next -> ", "注(近)", "闪(分)", "炸(解)", "注(远)", "闪(集)", "炸(不)"],
	// RK-9机库 (RK-9 Kennel)
	RK_BOSS_1 : [
		{id: 104, msg: '→ 前夹(晕坦) ←'},
		{id: 112, msg: '↓ 后砸 ↓'},
	...
	Baharr : [
		...
		{id: 135, msg: '完美格挡'},
		// 直线类
		{id: 126, msg: '右后拉'}, // 125 126 127
		{id: 132, msg: '左后拉'}, // 131 132 134
		{id: 101, msg: '锤地->270->重击'}, // 105 -> 270扫飞(格挡)  107 -> 重击(闪避)
		{id: 121, msg: '左  (4连半月)'},
		{id: 122, msg: '左  第3下加速'},
		{id: 123, msg: '左  第2下加速'},
		{id: 140, msg: '右  (4连半月)'},
		...
		{id: 119, msg: '右侧安全 →→', msg_tk: '← ←← ←←←', sign_degrees: 270},
		{id: 120, msg: '←← 左侧安全', msg_tk: '→→→ →→ →', sign_degrees:  90}
	],
	Baharr_TipMsg : ["四连半月(就绪)", "红眼射线 (秒杀)", "以 [暈眩技能] 阻止 震怒的暴風 施展", "发光后砸"],
	...
	GV_BOSS_1 : [
		...
		{id: 133, msg: '跳扑(击飞)1'},
		{id: 113, msg: '(慢)跳扑(击飞)1'},
		{id: 138, msg: '跳扑(击飞)2'},
		{id: 118, msg: '(慢)跳扑(击飞)2'},
