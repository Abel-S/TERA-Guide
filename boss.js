module.exports = {
	...
	CK_BOSS : [
		{id: 101, msg: '普攻-右脚(火)'},// "오른발화염공격_Atk01_d_노멀"
		{id: 102, msg: '普攻-左脚(冰)'},// "왼발냉기공격_Atk02_d_노멀"
		{id: 103, msg: '后方-尾巴攻击'},// "꼬리공격_BackAtk_노멀"
		{id: 104, msg: 'AOE-寒冰魔法'},// "주변광역냉기마법_HeavyAtk01_노멀"
		{id: 105, msg: 'AOE-火焰魔法'},// "주변광역화염마법_HeavyAtk02_노멀"
		{id: 106, msg: '前方-驴打滚'},// "전방돌진공격_MoveAtk_노멀"
		{id: 107, msg: '双脚-左冰右火'},// "주변리액션공격_ReactionAtk_노멀"
		{id: 108, msg: '右转-顺时针(火)'},// "회전공격(좌부터)_RoundAtk01_노멀"
		{id: 109, msg: '左转-逆时针(冰)'},// "회전공격(우부터)_RoundAtk02_노멀"
		
		{id: 151, msg: '张力1 普攻-右脚(火)'},// "텐션1_오른발화염공격_Atk01_d_노멀"
		{id: 152, msg: '张力1 普攻-左脚(冰)'},// "텐션1_왼발냉기공격_Atk02_d_노멀"
		{id: 153, msg: '张力1 后方-尾巴攻击'},// "텐션1_꼬리공격_BackAtk_노멀"
		{id: 154, msg: '张力1 AOE-寒冰魔法'},// "텐션1_주변광역냉기마법_HeavyAtk01_노멀"
		{id: 155, msg: '张力1 AOE-火焰魔法'},// "텐션1_주변광역화염마법_HeavyAtk02_노멀"
		{id: 156, msg: '张力1 前方-驴打滚'},// "텐션1_전방돌진공격_MoveAtk_노멀"
		{id: 157, msg: '张力1 双脚-左冰右火'},// "텐션1_주변리액션공격_ReactionAtk_노멀"
		{id: 158, msg: '张力1 右转-顺时针(火)'},// "텐션1_회전공격(좌부터)_RoundAtk01_노멀"
		{id: 159, msg: '张力1 左转-逆时针(冰)'},// "텐션1_회전공격(우부터)_RoundAtk02_노멀"
		...
		{id: 110, msg: '右脚 火炎DOT攻击'},// "오른발화염DOT공격_Atk01_발사동작_노멀"
	//  {id: 111, msg: '右脚火炎DOT攻击-发射'},// "오른발화염DOT공격_Atk01_발사체_노멀"
		{id: 112, msg: '左脚 冷气DOT攻击'},// "왼발냉기DOT공격_Atk02_발사동작_노멀"
	//  {id: 113, msg: '左脚冷气DOT攻击-发射'},// "왼발냉기DOT공격_Atk02_발사체_노멀"
		{id: 114, msg: '前方 火坑DOT魔法'},// "전방화염DOT마법_HeavyAtk02_발사동작_노멀"
	//  {id: 115, msg: '前方 火焰DOT魔法-发射'},// "전방화염DOT마법_HeavyAtk02_발사체_노멀"
		...
		{id: 137, msg: '[暴走]凯克·赛克 挤出力量'},// "[폭주]켈사이크_힘을짜냄_변신"
		
		{id: 138, msg: '[相位]相位变更'},// "[페이즈]페이즈변경_Wait_노멀"
		{id: 139, msg: '[温度]60温度变更(火)'},// "[온도]60_온도변경_Wait_노멀"
		{id: 140, msg: '[温度]40温度变更(冰)'},// "[온도]40_온도변경_Wait_노멀"
		
		{id: 141, msg: '左(火)转 外冰内火 | 左火右冰'},// "불근얼원_회전공격(좌/역속성사망)_RoundAtk01_노멀"
		{id: 142, msg: '左(火)转 外火内冰 | 左火右冰'},// "불원얼근_회전공격(좌/역속성사망)_RoundAtk01_노멀"
		{id: 143, msg: '右(冰)转 外火内冰 | 左火右冰'},// "얼근불원_회전공격(우/역속성사망)_RoundAtk02_노멀"
		{id: 144, msg: '右(冰)转 外冰内火 | 左火右冰'},// "얼원불근_회전공격(우/역속성사망)_RoundAtk02_노멀"
		
		{id: 145, msg: '双脚-左冰右火 | 眩晕攻击'},// "스턴공격_ReactionAtk_노멀"
